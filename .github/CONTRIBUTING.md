...
1. [Create a fork](https://help.github.com/articles/fork-a-repo) of the upstream
   repository at [`digital-botanical-gardens-initiative/taxo_info_fetcher`](https://github.com/digital-botanical-gardens-initiative/taxo_info_fetcher)
   on your GitHub account (or in one of your organizations)
2. [Clone your fork](https://docs.github.com/en/repositories/creating-and-managing-repositories/cloning-a-repository)
   with `git clone https://github.com/<your namespace here>/taxo_info_fetcher.git`
...
```shell
$ git remote add digital-botanical-gardens-initiative https://github.com/digital-botanical-gardens-initiative/taxo_info_fetcher.git
```
